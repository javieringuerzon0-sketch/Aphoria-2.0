...
const TrustBar: React.FC = () => {
  ...
  return (
    <section className="relative py-16 md:py-20 bg-gradient-to-b from-white to-aphoria-bg/30 border-t border-b border-aphoria-black/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-br from-aphoria-gold to-aphoria-green mb-6">
