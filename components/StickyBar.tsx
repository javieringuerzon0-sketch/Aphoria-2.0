        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 md:py-4 flex items-center justify-between gap-3 md:gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-6">
              ...
              <button
                onClick={openCart}
                className="group relative overflow-hidden bg-gradient-to-r from-aphoria-green to-aphoria-green/90 text-white rounded-full px-6 md:px-8 py-3 md:py-3.5 text-[10px] md:text-[11px] uppercase tracking-[0.26em] font-bold hover:scale-105 transition-transform shadow-[0_8px_20px_rgba(15,59,46,0.25)] whitespace-nowrap"
              >
