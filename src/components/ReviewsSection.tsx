...
const DEFAULT_REVIEWS: Record<string, CustomerReview[]> = {
  '24-gold-mask': [
    ...
    },
    {
      ...
      text: "Right after the first mask my skin felt like silk — so smooth and hydrated. Each day it kept getting better. By week 2 my texture was completely even. Now at 28 days, the difference in my before/after photos is shocking. My skin genuinely looks 3-4 years younger.",
      skinType: 'Dry',
      helpfulCount: 29,
    },
    {
      ...
      text: "I'm a makeup artist and I know skincare. Applied the Gold Mask before bed, woke up with visibly brighter skin. The 24K gold particles give an instant luminosity that lasts all day. After 28 days of consistent use, my skin has reversed years of damage. Every single client asks what I'm using.",
      skinType: 'Normal',
      helpfulCount: 63,
    },
    {
      ...
      text: 'Was nervous spending the money but the 60-day guarantee made me go for it. First application: my skin was glowing and plump within 20 minutes. By day 3, I stopped wearing foundation. Day 28, my sister said I look like I got professional treatments. Got the bundle — now I alternate Gold and Avocado daily.',
      skinType: 'Sensitive',
      helpfulCount: 41,
    },
  ],
  'avocado-mask': [
    ...
    },
    {
      ...
      text: "First night: woke up with the softest skin I've had in years. No greasy residue, just pure hydration that absorbed beautifully. By week 1, my uneven texture was smoothing out. After 28 days, my dermatologist noticed the improvement without me saying anything. Better than products 5x the price.",
      skinType: 'Combination',
      helpfulCount: 42,
    },
    {
      ...
      text: "I have rosacea and most products burn. The Avocado Mask felt soothing IMMEDIATELY — zero irritation. By day 3, my redness was visibly less. Day 10, I went makeup-free for the first time in years. After the full 28-day protocol, my skin looks calm, even, and genuinely younger. Life changing.",
      skinType: 'Sensitive',
      helpfulCount: 61,
    },
    {
      ...
      text: "Most products wear off by noon. This one? Applied at night, woke up STILL hydrated. By evening my skin was still soft. That's when I knew this was different. After 28 days of daily use, my skin has this natural glow I haven't had since my early twenties. The natural ingredients are a huge bonus.",
      skinType: 'Normal',
      helpfulCount: 33,
    },
    {
    ...
    },
    {
      ...
      text: "First application and my face felt like I just left a spa — instant deep hydration. By day 3 I ordered the bundle to add the Gold Mask. Now I alternate: Avocado mornings, Gold evenings. 28 days later my skin has completely transformed — firmer, brighter, younger. Best skincare decision I've ever made.",
      skinType: 'Mature',
      helpfulCount: 39,
    },
  ],
