    ...
    <footer className="bg-gradient-to-b from-aphoria-bg to-white/50 pt-20 pb-0">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-16">
          {/* Left: Brand */}
          <Link to="/" className="inline-flex items-center gap-4 transform transition-transform duration-300 hover:scale-105">
            <Logo className="h-16 md:h-20 w-auto" />
            <h3 className="text-5xl md:text-6xl font-brand font-light text-aphoria-black tracking-tight">
              Aphoria
            </h3>
          </Link>
