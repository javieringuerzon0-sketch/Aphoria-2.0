    ...
    <section className="relative h-screen w-full overflow-hidden flex items-end pb-24 md:pb-28">
      ...
      <div className="relative z-20 w-full max-w-[1360px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          >
            <button className="inline-flex items-center gap-3 px-12 py-4 rounded-full text-[10px] font-bold tracking-[0.2em] uppercase transition-all duration-500 shadow-lg hover:shadow-xl group" style={{ backgroundColor: '#0F3B2E', color: 'white' }} onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#C6A15B'; (e.currentTarget as HTMLButtonElement).style.color = '#111111'; }} onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.backgroundColor = '#0F3B2E'; (e.currentTarget as HTMLButtonElement).style.color = 'white'; }}>
              Get 60-Day Supply
