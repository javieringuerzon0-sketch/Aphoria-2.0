...
export const PRODUCTS: Product[] = [
  {
    ...
    ugc: [
      { id: 1,  img: '/goldmask-landing/ugc/canvas-image-1765489180063.webp',                                              user: "@sofia_beauty",      text: "My skin has never felt so firm. The glow is instant!" },
      { id: 2,  img: '/goldmask-landing/ugc/canvas-image-1765490110626.webp',                                              user: "@luxury_skincare",   text: "Pure excellence in a tube." },
      { id: 3,  img: '/goldmask-landing/ugc/canvas-image-1765519474195.webp',                                              user: "@glow_up_daily",     text: "15 minutes and I'm ready for the week." },
      { id: 4,  img: '/goldmask-landing/ugc/canvas-image-1765519592416.webp',                                              user: "@beauty_log",        text: "Unbelievable texture refinement." },
      { id: 5,  img: '/goldmask-landing/ugc/canvas-image-1765519661800.webp',                                              user: "@clinical_results",  text: "The data doesn't lie. 24K is the future." },
      { id: 6,  img: '/goldmask-landing/ugc/canvas-image-1765519809768.webp',                                              user: "@skincare_junkie",   text: "Obsessed with the immediate glow up." },
      { id: 7,  img: '/goldmask-landing/ugc/freepik__-ugcphotographyvariations-id-goldugcen01-category-__2294.webp',      user: "@derm_expert",       text: "Molecular synthesis at its finest. Highly recommend." },
      { id: 8,  img: '/goldmask-landing/ugc/freepik__-ugcphotographyvariations-id-goldugcen01-category-__2295.webp',      user: "@golden_ritual",     text: "This mask has completely transformed my routine." },
      { id: 9,  img: '/goldmask-landing/ugc/freepik__beautiful-woman-in-her-early-30s-smiling-while-hol__2296.webp',      user: "@morning_glow",      text: "I wake up glowing every single day." },
      { id: 10, img: '/goldmask-landing/ugc/freepik__woman-between-25-and-35-years-old-with-healthy-glo__2298.webp',      user: "@skin_results",      text: "Firmer, brighter, smoother — all in one mask." },
      { id: 11, img: '/goldmask-landing/ugc/freepik__platform-freepik-ai-imagegeneratormodel-mysticaspe__2307.webp',      user: "@aphoria_fan",       text: "Worth every penny. My skin loves this." },
      { id: 12, img: '/goldmask-landing/ugc/freepik__modelo-identica-mostrando-mi-producto-de-forma-nat__2308.webp',      user: "@beauty_routine",    text: "Holds up against everything I've tried before." },
      { id: 13, img: '/goldmask-landing/ugc/freepik__platform-freepik-ai-image-generatormodel-mysticasp__2311.webp',      user: "@radiant_skin",      text: "The texture and finish are absolutely luxurious." },
      { id: 14, img: '/goldmask-landing/ugc/freepik__pplatform-freepik-ai-image-generatormodel-mysticas__2313.webp',      user: "@glow_journal",      text: "Visible results after the very first application." },
      { id: 15, img: '/goldmask-landing/ugc/freepik__photorealistic-image-of-sofia-in-amodern-white-bat__2315.webp',      user: "@skin_obsessed",     text: "My dermatologist approved and I can see why." },
      { id: 16, img: '/goldmask-landing/ugc/freepik__photorealistic-image-of-sofia-taking-amirror-selfi__2317.webp',      user: "@beauty_science",    text: "The 24K gold is not just marketing — it works." },
      { id: 17, img: '/goldmask-landing/ugc/freepik__photorealistic-image-of-the-model-aphoriaaphoria-o__2322.webp',      user: "@skin_clarity",      text: "Pores tightened, glow amplified. 10/10." },
      { id: 18, img: '/goldmask-landing/ugc/freepik__platform-freepik-ai-image-generatormodel-mysticasp__42520.webp',     user: "@daily_ritual",      text: "I call this my Sunday skin reset. Game changer." }
    ],
  ...
  },
  {
    ...
    ugc: [
      ...
      { id: 1,  img: '/avocado-landing/ugc/freepik__young-woman-with-jade-green-aphoria-eye-patches-ap__2286.webp',              user: "@jade_skin_ritual",    text: "These eye patches are everything. Zero puffiness by morning." },
      { id: 2,  img: '/avocado-landing/ugc/freepik__beautiful27yearold-woman-jade-green-hydrogel-eye-p__2287.webp',              user: "@hydrogel_obsessed",    text: "Instant depuff. My under-eyes have never looked better." },
      { id: 3,  img: '/avocado-landing/ugc/freepik__-platform-freepik-ai-image-generator-model-sofiabr__2285.webp',             user: "@sofia_skin_diary",    text: "I use these every Sunday — total reset for my skin." },
      { id: 4,  img: '/avocado-landing/ugc/freepik__-platform-freepik-ai-image-generator-model-mystic-__2280.webp',            user: "@clean_beauty_lab",    text: "Redness gone in minutes. This mask is pure calm." },
      { id: 5,  img: '/avocado-landing/ugc/freepik__creame-una-variacion-para-esta-imagen-sorpreneme-i__2281.webp',            user: "@botanical_rituals",   text: "Rich, soothing, and smells incredible. Obsessed." },
      /* ── TIER 2: Canvas AI (estilizado, alta calidad) ── */
      { id: 6,  img: '/avocado-landing/ugc/canvas-image-1765494737512.webp',                                                    user: "@avocado_skin_co",    text: "The texture is absolute luxury. Nothing compares." },
      { id: 7,  img: '/avocado-landing/ugc/canvas-image-1765519919814.webp',                                                    user: "@derm_approved_skin", text: "Ceramides made a visible difference in one week." },
      { id: 8,  img: '/avocado-landing/ugc/canvas-image-1765520585278.webp',                                                    user: "@barrier_first",      text: "My skin barrier has never felt this strong." },
      { id: 9,  img: '/avocado-landing/ugc/canvas-image-1765520637566.webp',                                                    user: "@skin_food_fan",      text: "Clinically proven barrier support — and it shows." },
      /* ── TIER 3: Grok (fotorrealista, buena variedad de poses) ── */
      { id: 10, img: '/avocado-landing/ugc/grok-image-9d1e4fe9-b0f6-4c6b-87d9-a772323e961d%20%282%29.webp',                    user: "@natural_glow_co",    text: "Saved my dry skin overnight. Woke up glowing." },
      { id: 11, img: '/avocado-landing/ugc/grok-image-9d1e4fe9-b0f6-4c6b-87d9-a772323e961d%20%285%29.webp',                    user: "@glow_from_within",   text: "I put this on before bed and woke up to new skin." },
      { id: 12, img: '/avocado-landing/ugc/grok-image-9d1e4fe9-b0f6-4c6b-87d9-a772323e961d%20%2810%29.webp',                   user: "@skin_restore_daily", text: "Deep hydration without any greasy feeling. Love it." },
      { id: 13, img: '/avocado-landing/ugc/grok-image-9d1e4fe9-b0f6-4c6b-87d9-a772323e961d%20%2812%29.webp',                   user: "@moisturize_daily",   text: "My holy grail for winter skin. Stock up now." },
      /* ── TIER 4: JPG auténticos (credibilidad UGC real) ── */
      { id: 14, img: '/avocado-landing/ugc/2d271056-d75b-4b1a-b38b-740b742bb662.webp',                                         user: "@green_beauty",       text: "Finally found my skin's perfect match." },
      { id: 15, img: '/avocado-landing/ugc/38e7a424-0c82-4d78-95f4-038f2e13ae20.webp',                                         user: "@skin_calm",          text: "Sensitive skin approved. Zero irritation." },
      { id: 16, img: '/avocado-landing/ugc/6073b40b-22db-4d45-ac46-db77e08dc785.webp',                                         user: "@barrier_pro",        text: "Soothing, rich, and incredibly effective." },
      { id: 17, img: '/avocado-landing/ugc/ca75aae7-e00b-49d6-a166-1d48fde59a70.webp',                                         user: "@avocado_lover",      text: "My skin drinks this up every single time." },
      { id: 18, img: '/avocado-landing/ugc/f61e9033-3d46-4143-a26b-8b9b59ccd0a6.webp',                                         user: "@restore_glow",       text: "Plump, dewy, and glowing — every morning." },
      { id: 19, img: '/avocado-landing/ugc/section-imagen%202.webp',                                                            user: "@skincare_sci",       text: "This is what real results look like. I'm converted." }
    ],
